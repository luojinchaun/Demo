...
ComboBox {
    ...
    property color hoverColor: "#4F4F4F"
    property color pressColor: "#363636"
    ...
    background: Rectangle {
        ...
        border.color: txt.activeFocus ? "#FFFFFF" : "#9B9B9B"
    ...
    indicator: Canvas {
        ...
        onPaint: {
            ...
            context.closePath();
            context.fillStyle = comboBox.pressed ? "#FFFFFF" : "#9B9B9B"
            context.fill();
        }
    }
